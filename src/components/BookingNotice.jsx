  ...
  return (
    <section className="py-20 bg-obsidian-950 border-t border-white/10 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-card-gold p-8 md:p-12 rounded-3xl relative overflow-hidden border border-gold-500/50 shadow-[0_0_50px_rgba(245,158,11,0.25)]">
          
          {/* Glowing Background Radar Spotlights */}
          <div className="absolute -top-16 -right-16 w-80 h-80 bg-gold-500/15 rounded-full blur-[100px] pointer-events-none"></div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center relative z-10">
            
            <div className="lg:col-span-2">
              <div className="flex items-center gap-2 mb-3">
                <span className="px-3 py-1 rounded-md text-[11px] font-mono font-bold uppercase tracking-wider bg-gold-500/20 text-gold-300 border border-gold-500/40 flex items-center gap-1.5 shadow-md">
                  <i className="ri-alarm-warning-line text-gold-400"></i>
                  MANDATORY FLIGHT PLANNING POLICY
                </span>
                <span className="text-slate-400 text-xs font-mono">CAA UK COMPLIANT</span>
              </div>

              <h3 className="font-display font-black text-2xl md:text-4xl text-white tracking-tight">
                Reserve Your Flight Session <span className="text-gold-400 text-glow-gold">At Least 1 Week In Advance</span>
              </h3>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-4 text-xs font-mono font-semibold text-slate-300">
                <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-obsidian-950/80 border border-white/10">
            ...
            <div className="flex flex-col sm:flex-row lg:flex-col gap-3 justify-end">
              <button
                ...
                className="btn-shimmer w-full py-4 px-6 rounded-2xl font-mono font-bold text-xs bg-gold-gradient text-obsidian-950 shadow-[0_0_25px_rgba(245,158,11,0.4)] hover:shadow-[0_0_35px_rgba(245,158,11,0.6)] transition-all flex items-center justify-center gap-2"
              >
